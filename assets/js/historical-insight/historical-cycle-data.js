(() => {
  ...
  window.MacroWatchHistoricalCycles = Object.freeze({ caseFields, marketFields, normalizeCase, normalizeMarket, createRepository, marketCycle, calculate, chartPoints });
})();
