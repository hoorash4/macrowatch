(() => {
  ...
  function createRepository(client){
    ...
    const catalog=()=>Object.freeze((window.MacroWatchEconomicSeriesRegistry?.allSeries||[]).filter(item=>!INDEX_CODES.has(item.code)));
  ...
  window.MacroWatchHistoricalIndicators=Object.freeze({createRepository,normalize});
})();
