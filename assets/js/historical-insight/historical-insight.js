(() => {
  ...
  function indicatorBadgeSummary(item,context){
    ...
    const nearMisses=referenceOrder.filter(type=>{
      if(anchors.includes(type)||!dates[type])return false;
