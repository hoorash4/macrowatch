(() => {
  ...
  const SERIES=[
    ...
    {code:'US_POLICY_RATE_MID',compareCode:'KR_POLICY_RATE',title:'기준금리',legendTitle:'미국 기준금리',compareTitle:'한국 기준금리',frequency:'E',frequencyLabel:'미국 결정일 · 한국 1개월',unit:'%',category:RATE_CATEGORY,decimals:2,lineType:'steps',maAvailable:false},
    ...
    {code:'US_RETAIL_SALES',title:'미국 소매판매',frequency:'M',unit:'% YoY',category:'고빈도 경기',decimals:2},
    ...
    {code:'US_CPI',compareCode:'US_CORE_CPI',title:'미국 CPI',compareTitle:'미국 Core CPI',frequency:'M',unit:'% YoY',category:'물가',decimals:2},
    ...
    {code:'US_COMMERCIAL_CH11',title:'미국 기업회생 신청건수',frequency:'M',unit:'건',category:BUSINESS_DISTRESS_CATEGORY,decimals:0},
