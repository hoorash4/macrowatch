...
fact_definitions as (
  ...
  from (values
    ...
    ('ALL', 'US10Y2Y', '미국 10Y-2Y', '금리곡선', '%p', 2, 2, 0, 10),
    ('ALL', 'US_CPI', '미국 CPI', '물가', '% YoY', 2, 3, 45, 120),
    ('ALL', 'NFCI_CREDIT', '미국 신용여건', '금융여건', '지수', 3, 4, 7, 21),
    ('ALL', 'USDKRW', '원/달러', '환율', '원', 2, 5, 0, 10),
    ('KOSPI', 'KR_CORP_CREDIT_SPREAD', '한국 회사채 스프레드', '한국 신용', '%p', 3, 6, 0, 10),
    ('KOSPI', 'KOSPI_PER', 'KOSPI PER', '밸류에이션', '배', 2, 7, 0, 10)
  ) as definitions(
