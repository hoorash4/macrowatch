-- One-time full-history repair after validating parser v9 against a financial
-- holding company's published consolidated income statement. Market-share
-- tables are excluded and financial-company statement labels are supported.
...
select
  ...
  jsonb_strip_nulls(jsonb_build_object(
    ...
    'legacy_archive', true,
    'legacy_full_history_parser_version', 9,
    'repair_reason', 'exclude_market_share_and_parse_financial_company_statements'
  )),
  'legacy_archive'
