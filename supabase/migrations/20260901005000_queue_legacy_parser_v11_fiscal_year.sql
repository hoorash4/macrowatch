-- One-time full-history repair after parser v11 began rejecting valid-looking
-- financial-statement attachments whose period belongs to another fiscal year.
...
select
  ...
  jsonb_strip_nulls(jsonb_build_object(
    ...
    'legacy_archive', true,
    'legacy_full_history_parser_version', 11,
    'repair_reason', 'reject_financial_statement_attachments_from_other_fiscal_years'
  )),
  'legacy_archive'
