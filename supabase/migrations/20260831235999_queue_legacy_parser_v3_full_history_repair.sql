...
-- It rebuilds every official 2002-2014 legacy filing with parser v3 so the
-- shifted interim-header correction is applied consistently across history.
with latest_filings as (
  ...
  where filings.source = 'open_dart'
    and filings.fiscal_year between 2002 and 2014
...
select
  ...
  jsonb_strip_nulls(jsonb_build_object(
    ...
    'legacy_archive', true,
    'legacy_full_history_parser_version', 3,
    'repair_reason', 'correct_shifted_interim_headers_full_history'
  )),
  'legacy_archive'
