-- One-time full-history repair after validating parser v10 against published
-- legacy income statements whose revenue row is labelled simply as `매출`.
...
select
  ...
  jsonb_strip_nulls(jsonb_build_object(
    ...
    'legacy_archive', true,
    'legacy_full_history_parser_version', 10,
    'repair_reason', 'parse_plain_revenue_label_in_published_income_statements'
  )),
  'legacy_archive'
