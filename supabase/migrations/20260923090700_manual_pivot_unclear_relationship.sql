-- Extend only the administrator-entered relationship vocabulary.
begin;
set local statement_timeout = '10s';
alter table public.historical_indicator_manual_pivots
  drop constraint historical_indicator_manual_pivots_relationship_check;
alter table public.historical_indicator_manual_pivots
  add constraint historical_indicator_manual_pivots_relationship_check
  check (relationship in ('positive','inverse','unclear'));
