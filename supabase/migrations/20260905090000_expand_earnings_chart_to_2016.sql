-- Recalculate and expose the complete Korean earnings history beginning in 2016.
...
as $$
  ...
  from earnings_v2.market_quarters q
  where q.market_id = p_market_id and q.market_year >= 2016
