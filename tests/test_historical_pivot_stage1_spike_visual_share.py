...
class SpikeVisualShareTests(unittest.TestCase):
    def test_upward_spike_requires_25_percent_of_visible_y_axis(self):
        d = date(2020, 1, 1)
        highs = (
        ...
        result = augment_spike_entry_points(base, geometry, angle_threshold_deg=179.0)
        self.assertEqual((), result.spike_peaks)

    def test_upward_spike_passes_when_visual_y_share_reaches_25_percent(self):
        d = date(2020, 1, 1)
        highs = (
