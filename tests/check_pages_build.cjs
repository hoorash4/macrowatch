...
const accountModalIndex = builtIndex.indexOf('assets/js/core/account-modal.js?v=4');
const accountModalDataIndex = builtIndex.indexOf('assets/js/core/account-modal-data.js?v=2');
const mainAuthIndex = builtIndex.indexOf('assets/js/core/auth.js');
assert.ok(accountModalIndex >= 0 && accountModalDataIndex > accountModalIndex && mainAuthIndex > accountModalDataIndex,
